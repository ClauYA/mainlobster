...
- **Lobster How-To**: Step-by-step guide for first-time lobster diners
- **Location Info**: Hours, address, and practical visitor information
- **Smooth Navigation**: Anchor links to page sections
...
- CSS3 (Flexbox, Grid)
- Vanilla JavaScript
- Google Fonts (Gabarito, Lexend, Roboto, Source Sans 3, Titan One)
